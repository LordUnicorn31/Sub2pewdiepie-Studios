...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_WALL][COLLIDER_PLAYER1_LOWKICK] = false;
	matrix[COLLIDER_WALL][COLLIDER_PLAYER2_LOWKICK] = false;
	...
	matrix[COLLIDER_PLAYER1][COLLIDER_PLAYER1_LOWKICK] = false;
	matrix[COLLIDER_PLAYER1][COLLIDER_PLAYER2_LOWKICK] = false;
	...
	matrix[COLLIDER_PLAYER2][COLLIDER_PLAYER1_LOWKICK] = false;
	matrix[COLLIDER_PLAYER2][COLLIDER_PLAYER2_LOWKICK] = false;

	matrix[COLLIDER_PLAYER1_HADOUKEN][COLLIDER_WALL] = true;
	matrix[COLLIDER_PLAYER1_HADOUKEN][COLLIDER_PLAYER1] = false;
	matrix[COLLIDER_PLAYER1_HADOUKEN][COLLIDER_PLAYER2] = false;
	...
	matrix[COLLIDER_PLAYER1_HADOUKEN][COLLIDER_PLAYER1_LOWKICK] = false;
	matrix[COLLIDER_PLAYER1_HADOUKEN][COLLIDER_PLAYER2_LOWKICK] = false;
	...
	matrix[COLLIDER_PLAYER2_HADOUKEN][COLLIDER_PLAYER1_LOWKICK] = false;
	matrix[COLLIDER_PLAYER2_HADOUKEN][COLLIDER_PLAYER2_LOWKICK] = false;
	...
	matrix[COLLIDER_PLAYER1_PUNCH][COLLIDER_PLAYER1_LOWKICK] = false;
	matrix[COLLIDER_PLAYER1_PUNCH][COLLIDER_PLAYER2_LOWKICK] = false;
	...
	matrix[COLLIDER_PLAYER2_PUNCH][COLLIDER_PLAYER1_LOWKICK] = false;
	matrix[COLLIDER_PLAYER2_PUNCH][COLLIDER_PLAYER2_LOWKICK] = false;

	matrix[COLLIDER_PLAYER1_LOWKICK][COLLIDER_WALL] = true;
	matrix[COLLIDER_PLAYER1_LOWKICK][COLLIDER_PLAYER1] = false;
	matrix[COLLIDER_PLAYER1_LOWKICK][COLLIDER_PLAYER2] = true;
	matrix[COLLIDER_PLAYER1_LOWKICK][COLLIDER_PLAYER1_PUNCH] = false;
	matrix[COLLIDER_PLAYER1_LOWKICK][COLLIDER_PLAYER2_PUNCH] = false;
	matrix[COLLIDER_PLAYER1_LOWKICK][COLLIDER_PLAYER1_LOWKICK] = false;
	matrix[COLLIDER_PLAYER1_LOWKICK][COLLIDER_PLAYER2_LOWKICK] = false;

	matrix[COLLIDER_PLAYER2_LOWKICK][COLLIDER_WALL] = true;
	matrix[COLLIDER_PLAYER2_LOWKICK][COLLIDER_PLAYER1] = false;
	matrix[COLLIDER_PLAYER2_LOWKICK][COLLIDER_PLAYER2] = true;
	matrix[COLLIDER_PLAYER2_LOWKICK][COLLIDER_PLAYER1_PUNCH] = false;
	matrix[COLLIDER_PLAYER2_LOWKICK][COLLIDER_PLAYER2_PUNCH] = false;
	matrix[COLLIDER_PLAYER2_LOWKICK][COLLIDER_PLAYER1_LOWKICK] = false;
	matrix[COLLIDER_PLAYER2_LOWKICK][COLLIDER_PLAYER2_LOWKICK] = false;
