...
SDL_Texture* bullet2_texture = nullptr;

Mix_Music* Music = nullptr;
Mix_Chunk* bullet_sound = nullptr;
Mix_Chunk* bullet2_sound = nullptr;
//Input
Key_State keys[300];
...
SDL_Rect bullet_rect = { -50, -50, 60, 30 };
SDL_Rect bullet2_rect = { -50, -50, 60, 30 };
bool shot = false;
...
void InitVariables()
{
	...
	bullet2_texture = IMG_LoadTexture(renderer, "Textures/bullet2.png");
	bg_texture = IMG_LoadTexture(renderer, "Textures/background.png");
	Music = Mix_LoadMUS("Music/music.wav");
	bullet_sound = Mix_LoadWAV("Music/bullet_sound.wav");
	bullet2_sound = Mix_LoadWAV("Music/bullet2_Sound.wav");
...
void Draw()
{
	...
	SDL_RenderCopy(renderer, bullet2_texture, nullptr, &bullet2_rect);
...
void UpdateLogic()
{
		...
		{
			bullet2_rect = { ship_rect.x + ship_rect.w, ship_rect.y + ship_rect.h / 2, bullet2_rect.w, bullet2_rect.h };
			Mix_PlayChannel(1, bullet2_sound, 0);
		}
		if (shot)
		{
			bullet2_rect.x += 10;
